    ...
    <div className="max-w-md mx-auto px-4 py-24">
      <Card glow variant="purple" className="border-electric-purple/20 bg-dark-surface/40 backdrop-blur-2xl p-10 relative overflow-hidden glass-panel">
        ...
        <div className="text-center mb-10">
          <div className="w-24 h-24 rounded-3xl bg-electric-purple/10 border border-electric-purple/30 flex items-center justify-center mx-auto mb-8 shadow-[0_0_30px_rgba(139,92,246,0.1)] relative group">
            <Shield className="w-12 h-12 text-electric-purple drop-shadow-[0_0_10px_rgba(139,92,246,0.5)] group-hover:scale-110 transition-transform" />
